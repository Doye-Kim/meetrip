...
class RecommendFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.commuTap.setOnClickListener{
            ...
            it.findNavController().navigate(R.id.action_recommendFragment_to_communityFragment)
        }

        binding.userTap.setOnClickListener{

            it.findNavController().navigate(R.id.action_recommendFragment_to_userFragment)
        }
